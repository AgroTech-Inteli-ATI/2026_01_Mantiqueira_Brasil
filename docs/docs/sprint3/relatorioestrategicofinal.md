...
| Zona | Raio | Produto Foco | Canal | Margem Esperada |
|------|------|--------------|--------|-----------------|
| Zona 1 Primária | 0–80 km | Composto Farelo + Digestato Líquido | Venda Direta ao Produtor | Alta |
...
| Cenário | Distância | EBITDA acumulado (2025–2030) | LAIR acumulado | Lucro Líquido acumulado |
|----------|-----------|------------------------------:|---------------:|------------------------:|
| Otimista | 100 km | +R$ 8,26M | -R$ 3,32M | -R$ 3,72M |
| Razoável | 200 km | -R$ 28,01M | -R$ 39,59M | -R$ 39,59M |
| Pessimista | 300 km | -R$ 64,28M | -R$ 75,86M | -R$ 75,86M |
...
- **Compradores:** Ipanema Agrícola, Minasul, Coopama e Cooxupé.
...
- **Compradores:** Grupo Scheffer, Grupo Bom Futuro e distribuidoras Lavoro/Sinagro.
...
|----------|--------|------------------------------|------------------------|
| Soja | MT / MG | Janeiro a Maio (antecipada) | Campanha Out–Dez com entrega escalonada |
| Milho Safrinha | MT | Novembro a Fevereiro | Venda programada com desconto de entressafra |
| Algodão | MT | Outubro a Dezembro | Contratos B2B diretos com grandes grupos |
| Café | MG | Maio a Agosto (pós-colheita) | Dias de Campo (Mai–Jun) + pedidos para Set–Dez |
...
|--------------|--------|------------------|---------------------|
| Produtores de cama de frango *in natura* | MG | Preço muito baixo na retirada | Higienização, laudo garantido e ausência de patógenos e plantas daninhas |
| Empresas de compostagem (lodo urbano/industrial) | MG / SP | Proximidade e relacionamento regional | Matéria-prima nobre da Mantiqueira: uniformidade e rastreabilidade |
...
| Item | Valor |
|------|------|
| Secador industrial (linhas a biomassa) | R$ 4.500.000 |
| Obra civil, galpão e instalação | R$ 2.500.000 |
| Licenças ambientais | R$ 500.000 |
| Equipamentos auxiliares (granulação, ensacadora) | R$ 1.500.000 |
| Frota logística (caminhões) | R$ 1.400.000 |
...
| CAPEX Total | R$ 11.990.000 |
| % Financiado | 70% |
| Montante da Dívida | R$ 8.393.000 |
| Taxa de Juros | CDI (14%) + Spread (5%) = 19% a.a. |
| Carência | 1 ano (2025) |
...
|-----------|------|------|------|------|------|------|
| Receita Bruta | R$ 43.200.000 | R$ 45.144.000 | R$ 47.175.480 | R$ 49.298.377 | R$ 51.516.804 | R$ 53.835.060 |
| Crescimento a.a. | — | 4,5% | 4,5% | 4,5% | 4,5% | 4,5% |
| Impostos sobre Vendas | R$ 3.456.000 | R$ 3.611.520 | R$ 3.774.038 | R$ 3.943.870 | R$ 4.121.344 | R$ 4.306.805 |
| Receita Líquida | R$ 39.744.000 | R$ 41.532.480 | R$ 43.401.442 | R$ 45.354.506 | R$ 47.395.459 | R$ 49.528.255 |
| Custos Variáveis | R$ 36.188.906 | R$ 37.817.407 | R$ 39.519.190 | R$ 41.297.554 | R$ 43.155.944 | R$ 45.097.961 |
| Custos Fixos | R$ 2.207.600 | R$ 2.285.360 | R$ 2.366.619 | R$ 2.451.535 | R$ 2.540.272 | R$ 2.633.002 |
| Lucro Bruto | R$ 1.347.494 | R$ 1.429.713 | R$ 1.515.632 | R$ 1.605.417 | R$ 1.699.243 | R$ 1.797.291 |
| Margem Bruta | 3,4% | 3,4% | 3,5% | 3,5% | 3,6% | 3,6% |
| (+) Descarte Evitado | R$ 2.890.800 | R$ 3.020.886 | R$ 3.156.826 | R$ 3.298.883 | R$ 3.447.333 | R$ 3.602.463 |
| (–) Despesas | R$ 360.000 | R$ 376.200 | R$ 393.129 | R$ 410.820 | R$ 429.307 | R$ 448.625 |
| EBITDA | R$ 3.878.294 | R$ 4.074.399 | R$ 4.279.329 | R$ 4.493.481 | R$ 4.717.269 | R$ 4.951.128 |
| Margem EBITDA | 9,8% | 9,8% | 9,9% | 9,9% | 10,0% | 10,0% |
| (–) Depreciação | R$ 0 | R$ 1.199.000 | R$ 1.199.000 | R$ 1.199.000 | R$ 1.199.000 | R$ 1.199.000 |
| EBIT | R$ 3.878.294 | R$ 2.875.399 | R$ 3.080.329 | R$ 3.294.481 | R$ 3.518.269 | R$ 3.752.128 |
| Margem EBIT | 9,8% | 6,9% | 7,1% | 7,3% | 7,4% | 7,6% |
| (–) Despesa Financeira | R$ 0 | R$ 1.594.670 | R$ 1.594.670 | R$ 1.196.003 | R$ 797.335 | R$ 398.668 |
| LAIR | R$ 3.878.294 | R$ 1.280.729 | R$ 1.485.659 | R$ 2.098.478 | R$ 2.720.934 | R$ 3.353.461 |
| (–) IRPJ/CSLL | R$ 1.318.620 | R$ 435.448 | R$ 505.124 | R$ 713.483 | R$ 925.118 | R$ 1.140.177 |
...
|----------|--------|--------|--------|
| Frete total (6 anos) | R$ 36,3M | R$ 72,5M | R$ 108,8M |
| EBITDA 2025 | R$ 1.178.294 | –R$ 4.221.706 | –R$ 9.621.706 |
...
|--------------|----------|---------|--------------|------------|
| R1: Foco no raio primário | 0–6m | Alto | Baixa | ★★★★★ |
| R2: Acordos com cooperativas MG | 0–6m | Alto | Média | ★★★★★ |
| R3: Talhões demonstrativos | 0–6m | Médio | Baixa | ★★★★☆ |
| R4: Dashboard logístico | 0–6m | Alto | Média | ★★★★★ |
| R5: Linha peletizada (MG primeiro) | 6–18m | Muito Alto | Alta | ★★★★★ |
| R6: Anti-sazonalidade (3 pilares) | 6–18m | Alto | Média | ★★★★☆ |
| R7: Rede de revendas/distribuidores | 6–18m | Alto | Média | ★★★★☆ |
| R8: Protocolo técnico consultivo | 6–18m | Alto | Baixa | ★★★★★ |
| R9: Biogás/biometano integrado | 18–36m | Muito Alto | Alta | ★★★★☆ |
| R10: Rastreabilidade de carbono | 18–36m | Alto | Alta | ★★★☆☆ |
...
|------------|----------|-------------|
| Margem líquida por região atendida | Identificar mercados mais rentáveis | Mensal |
| Custo logístico por tonelada vendida | Controlar eficiência da distribuição | Mensal |
| Distância média de entrega (km) | Monitorar expansão do raio econômico | Mensal |
| % fretes realizados com retorno | Reduzir custo de transporte | Mensal |
| Volume vendido por faixa de raio | Avaliar desempenho dos anéis logísticos | Mensal |
| Taxa de retenção de clientes | Medir fidelidade do modelo consultivo | Trimestral |
